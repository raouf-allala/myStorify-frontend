...
const DashProducts = () => {
  ...
  useEffect(() => {
    axios
      .post(`http://localhost:3000/api/produits/dash/magasin/${magasin.id}`, {
        prixOrder,
        dateOrder,
        quantityOrder,
        categorieId,
  ...
  const getNext = (take, skip, last) => {
    axios
      .post(`http://localhost:3000/api/produits/paged/${magasin.id}`, {
        take,
        skip,
        prixOrder,
        dateOrder,
              ...
              products.map((product) => {
                return (
                  <DashProduct
                    ...
                    link={`/dashboard/magasin/${magasin.id}/products/${product.id}`}
                  />
                );
              })}
          </div>
